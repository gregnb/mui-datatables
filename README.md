...
|**`filterOptions`**|array or object||Filter options. it's possible use an array of values [Example](https://github.com/gregnb/mui-datatables/blob/master/examples/column-filters/index.js) or an object with names and logic [Example](https://github.com/gregnb/mui-datatables/blob/master/examples/customize-filter/index.js)
