...
|**`filterOptions`**|{names, logic}||Filter options. An object with names and logic [Example](https://github.com/gregnb/mui-datatables/blob/master/examples/customize-filter/index.js)
|**`customFilterListRender`**|function||Function that returns a string used as the chip label. `function(value) => string` [Example](https://github.com/gregnb/mui-datatables/blob/master/examples/column-filters/index.js) or it's still possible to use an array of names, this option has been deprecated [Example](https://github.com/gregnb/mui-datatables/blob/master/examples/column-filters/index.js)
