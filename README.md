...
|**`maxHeight`**|string|none(499px)|Change the maximum height. If you want to apply this option, set responsive to scrollMaxHeight. `enum('none', 'max-content', 'min-content', 'fit-content', 'fill-available')`
