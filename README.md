...
|**`onDownload`**|function||Callback function that triggers when the user downloads the CSV file. `function(buildHead:(columns) => string, buildBody(data) => string, columns, data) => string`
