...
|**`sortFn`**|function||Custom sort function for that column: `(order) => ({data: val1}, {data: val2}) => -1|1|0` [Example](https://github.com/gregnb/mui-datatables/blob/master/examples/column-sort/index.js). Note: currently doesn't work with table `customSort`
