...
describe('<TableFilterList />', () => {
  ...
  it(
    'should remove a filter chip and call onFilterChipClose when its X icon is clicked',
    () => {
      const options = {
        textLabels: getTextLabels(),
  ...
  it(
    'should correctly call customFilterListOptions.render and customFilterListOptions.update',
    () => {
