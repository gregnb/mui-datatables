...
describe('<TableFilter />', () => {
  ...
  it(
    "should render data table filter view with checkboxes if filterType = 'checkbox'",
    () => {
      const options = { filterType: 'checkbox', textLabels: getTextLabels() };
      const filterList = [[], [], [], []];
      const shallowWrapper = mount(
  ...
  it(
    'should render data table filter view with no checkboxes if filter=false for each column',
    () => {
      const options = { filterType: 'checkbox', textLabels: getTextLabels() };
      const filterList = [[], [], [], []];
  ...
  it(
    "should render data table filter view with selects if filterType = 'select'",
    () => {
  ...
  it(
    'should render data table filter view no selects if filter=false for each column',
    () => {
      const options = { filterType: 'select', textLabels: getTextLabels() };
      const filterList = [['Joe James'], [], [], []];
      columns = columns.map(item => (item.filter = false));
  ...
  it(
    "should render data table filter view with checkbox selects if filterType = 'multiselect'",
    () => {
  ...
  it(
    "should render data table filter view with custom rendering of items if filterType = 'select'",
    () => {
  ...
  it(
    "should render data table filter view with custom rendering of items for filterType = 'multiselect' if renderValue is provided",
    () => {
      columns.forEach(item => (item.filterOptions = { renderValue: v => v.toUpperCase() }));
      const options = { filterType: 'multiselect', textLabels: getTextLabels() };
      const filterList = [['Joe James', 'John Walsh'], [], [], []];
  ...
  it(
    "should data table custom filter view with if filterType = 'custom' and a valid display filterOption is provided",
    () => {
      const options = {
        filterType: 'custom',
        textLabels: getTextLabels(),
  ...
  it(
    "does not render filter if filterType = 'custom' and no display filterOption is provided",
    () => {
      const options = {
        filterType: 'custom',
        textLabels: getTextLabels(),
  ...
  it(
    "should data table filter view with checkboxes if column.filterType = 'checkbox' irrespective of global filterType value",
    () => {
      const options = { filterType: 'textField', textLabels: getTextLabels() };
      const filterList = [[], [], [], []];
  ...
  it(
    'should render a filter dialog with custom footer when customFooter is provided',
    () => {
