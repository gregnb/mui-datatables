...
describe('<MUIDataTable />', () => {
  ...
  it(
    'should correctly build internal table data and displayData structure when using nested data (option enableNestedDataAccess omitted )',
    () => {
      const columns = [
        {
          name: 'Name',
  ...
  it(
    'should correctly build internal table data and displayData structure with enabled nested data custom marker (option enableNestedDataAccess : "/OK/" )',
    () => {
      const columns = [
        {
          name: 'Name',
  ...
  it(
    'should correctly build internal table data and displayData structure with disabled nested data (option enableNestedDataAccess : "" )',
    () => {
      const columns = [
        {
          name: 'Name',
  ...
  it(
    'should correctly build internal table data and displayData structure with sortOrder set',
    () => {
  ...
  it(
    'should correctly re-build table options before and after prop change',
    () => {
      const options = {
        textLabels: {
          newObj: {
  ...
  it(
    'should correctly sort when sortDescFirst and sortThirdClickReset are true',
    () => {
      const columns = [
        {
          name: 'Name',
  ...
  it(
    'should correctly pass the sorted column name and direction to onColumnSortChange',
    () => {
  ...
  */
  ...
  it(
    'should allow empty array rowsPerPageOptions when provided in options',
    () => {
      const options = {
        rowsPerPageOptions: [],
      };
  ...
  it(
    'should not render select toolbar when selectToolbarPlacement="none"',
    () => {
  ...
  it(
    'should not render select toolbar when selectToolbarPlacement="none" and rowsSelected is inputted',
    () => {
  ...
  it(
    'should render both select toolbar and toolbar when selectToolbarPlacement="above"',
    () => {
  ...
  it(
    'should create Chip with custom label when filterList and customFilterListOptions are populated',
    () => {
      const filterList = [['Joe James'], [], [], [], []];
  ...
  it(
    'should call custom filter update function when it is passed into custom filter update',
    () => {
  ...
  it(
    'should render filter Chip(s) when options.serverSide = true and serverSideFilterList is populated',
    () => {
  ...
  it(
    'should not render filter Chip(s) when options.serverSide = true and serverSideFilterList is not populated',
    () => {
      const filterListRenderers = [
        defaultRenderCustomFilterList,
        defaultRenderCustomFilterList,
  ...
  it(
    'should remove entry from filterList when calling filterUpdate method with type=dropdown and an empty array',
    () => {
      const shallowWrapper = shallow(<MUIDataTable columns={columns} data={data} />);
      const table = shallowWrapper.dive();
      const instance = table.instance();
  ...
  it(
    'should have the proper type in onFilterChange when calling resetFilters method',
    () => {
      let type;
      const options = {
  ...
  it(
    'should render a footer after the tbody element when customTableBodyFooterRender is called',
    () => {
      const options = {};
  ...
  it(
    'should sort provided column with defined data, in ascending order when calling toggleSortColum method for the first time',
    () => {
  ...
  it(
    'should sort provided column with undefined data as though it were an empty string, in ascending order when calling toggleSortColum method for the first time',
    () => {
      const shallowWrapper = shallow(<MUIDataTable columns={columns} data={data} />).dive();
      const instance = shallowWrapper.instance();
  ...
  it(
    'should sort provided column in descending order when calling toggleSortColum method twice',
    () => {
      const shallowWrapper = shallow(<MUIDataTable columns={columns} data={data} />).dive();
      const instance = shallowWrapper.instance();
  ...
  it(
    'should sort provided column with custom column sort function (sort by name length) in descending order',
    () => {
  ...
  it(
    'should allow multiple cells to be selected when selectableRows=multiple and selectRowUpdate method with type=cell.',
    () => {
  ...
  it(
    'should allow multiple cells to be selected when selectableRows=multiple and selectRowUpdate method with type=cell and there are adjacent rows.',
    () => {
      const options = { selectableRows: 'multiple' };
      const shallowWrapper = shallow(<MUIDataTable columns={columns} data={data} options={options} />).dive();
      const instance = shallowWrapper.instance();
  ...
  it(
    'should allow multiple cells to be selected and then unselected when selectableRows=multiple and selectRowUpdate method with type=cell and there are adjacent rows.',
    () => {
      const options = { selectableRows: 'multiple' };
      const shallowWrapper = shallow(<MUIDataTable columns={columns} data={data} options={options} />).dive();
      const instance = shallowWrapper.instance();
  ...
  it(
    'should not update selectedRows when using rowsSelected option with type=none',
    () => {
      const options = {
        selectableRows: 'none',
        rowsSelected: [0],
  ...
  it(
    'should update selectedRows when using rowsSelected option with type=single',
    () => {
      const options = {
  ...
  it(
    'should update selectedRows when using rowsSelected option with type=multiple',
    () => {
      const options = {
  ...
  it(
    'should update selectedRows (with default type=multiple option) when using rowsSelected with no option specified',
    () => {
      const options = {
        rowsSelected: [0, 3],
      };
  ...
  it(
    'should update expandedRows when using expandableRows option with default rowsExpanded',
    () => {
      const options = {
        expandableRows: true,
        rowsExpanded: [0, 3],
  ...
  it(
    'should call onColumnOrderChange when updateColumnOrder is called',
    () => {
      const options = {
  ...
  it(
    'should call onRowExpansionChange when row is expanded or collapsed',
    () => {
      const options = {
        expandableRows: true,
        renderExpandableRow: () => (
  ...
  it(
    'should call onRowSelectionChange when row is selected or unselected',
    () => {
      const options = {
        selectableRows: 'multiple',
  ...
  it(
    'should correctly build internal tableProps when setTableProps passed in options',
    () => {
      const options = {
        setTableProps: () => ({
          className: 'foo bar',
  ...
  it(
    'should correctly execute customBodyRender methods based on filtering and data',
    () => {
      let filteredData = [];
